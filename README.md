...
### Compatibility
This chess engine supports **Ren'Py SDK >= 7.4.0** to **Ren'Py SDK < 8.0**. It is not backward compatible with **Ren'Py SDK <= 7.3.5** due to reasons described in [this GitHub issue](https://github.com/RuolinZheng08/renpy-chess/issues/14). See the `renpy-7.3.5` branch for [an old version that is compatible with Ren'Py SDK 7.3.5](https://github.com/RuolinZheng08/renpy-chess/tree/renpy-7.3.5).
